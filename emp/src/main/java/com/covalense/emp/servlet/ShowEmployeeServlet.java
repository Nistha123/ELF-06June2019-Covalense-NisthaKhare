...
public class ShowEmployeeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (httpSession == null) {
			...
			bean = dao.getEmployeeInfo(req.getParameter("id"));
			if (bean == null) {
				bean = (EmployeeInfoBean) httpSession.getAttribute("userData");
			} 
			...
			if (bean == null) {
				 ...
				 * ); out.print("<form action=\"./empSearch\" method=\"get\">"); out.print(
				 ...
				 * ); out.print(
				 * "    <hr>                                                                                                                                                                                                     "
				 * ); out.print("<BR>Id is " + bean.getId()); out.print("<BR>name is " +
				 * bean.getName()); out.print("<BR>phone is " + bean.getPhone());
				 * out.print("<BR>Age is " + bean.getAge()); out.print("<BR>Salary is " +
				 * bean.getSalary()); out.print("<BR>Account no is " + bean.getAcnt_no());
				 * out.print("<BR>DOB is " + bean.getDob()); out.print("<BR>Designation is " +
				 * bean.getDesignation()); out.print("<BR>Dept ID is " + bean.getDept_ID());
				 * out.print("<BR>Manager ID is " + bean.getManager_ID()); out.print(
