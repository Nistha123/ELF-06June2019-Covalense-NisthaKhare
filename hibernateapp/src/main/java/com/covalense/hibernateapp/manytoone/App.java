...
import com.covalense.hibernateapp.onetoone.HibernateImpl;
...
public class App {
	...
	public static void main(String[] args) {
		...
		EmployeeInfoBeanone beanone = new EmployeeInfoBeanone();
		beanone.setId(4);
