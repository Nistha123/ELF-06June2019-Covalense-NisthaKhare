...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark primary-color"
		...
		<!-- <form action="./validate2" method="get" class="form-inline"> -->
		 <form action="../validator/validate/employee/search" method="get" class="form-inline"> 
	...
	<BR>
	User Id : ${empBean.getId()}
	<BR>
	name is : ${empBean.getName()}
	<BR>
	phone is : ${empBean.getPhone()}
	<BR>
	Age is : ${empBean.getAge()}
	<BR>
	Salary is : ${empBean.getSalary()}
	<BR>
	Account no is : ${empBean.getAcnt_no()}
	<BR>
	Designation is : ${empBean.getDesignation()}
	<BR>
	DOB is : ${empBean.getDob()}
	<BR>
	Dept ID is : ${empBean.getDept_ID()}
	<BR>
	Manager ID is : ${empBean.getManager_ID()}
